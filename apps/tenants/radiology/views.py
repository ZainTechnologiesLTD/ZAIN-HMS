...
# Dashboard View
class RadiologyDashboardView(TenantSafeMixin, ListView):  # TenantFilterMixin temporarily commented:
...
# Study Type Views
class StudyTypeListView(TenantSafeMixin, ListView):  # TenantFilterMixin temporarily commented:
    model = StudyType
...
class StudyTypeCreateView(RequireHospitalSelectionMixin, CreateView):
    model = StudyType
...
class StudyTypeDetailView(TenantSafeMixin, DetailView):  # TenantFilterMixin temporarily commented:
    model = StudyType
...
class StudyTypeUpdateView(TenantSafeMixin, UpdateView):  # TenantFilterMixin temporarily commented:
    model = StudyType
    form_class = StudyTypeForm
    template_name = 'radiology/study_type_form.html'
...
class StudyTypeDeleteView(TenantSafeMixin, DeleteView):  # TenantFilterMixin temporarily commented:
    model = StudyType
...
class RadiologyOrderListView(TenantSafeMixin, ListView):  # TenantFilterMixin temporarily commented:
    model = RadiologyOrder
...
class RadiologyOrderCreateView(RequireHospitalSelectionMixin, CreateView):
    model = RadiologyOrder
...
class RadiologyOrderDetailView(TenantSafeMixin, DetailView):  # TenantFilterMixin temporarily commented:
    model = RadiologyOrder
...
class RadiologyOrderUpdateView(TenantSafeMixin, UpdateView):  # TenantFilterMixin temporarily commented:
    model = RadiologyOrder
    form_class = RadiologyOrderForm
    template_name = 'radiology/order_form.html'
...
class RadiologyOrderDeleteView(TenantSafeMixin, DeleteView):  # TenantFilterMixin temporarily commented:
    model = RadiologyOrder
...
class ImagingStudyCreateView(RequireHospitalSelectionMixin, CreateView):
    model = ImagingStudy
...
class RadiologyEquipmentCreateView(RequireHospitalSelectionMixin, CreateView):
    model = RadiologyEquipment
