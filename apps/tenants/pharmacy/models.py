...
class DrugCategory(models.Model):
    ...
    # tenant = models.ForeignKey(Tenant  # Temporarily commented, on_delete=models.CASCADE, related_name='drug_categories')
...
class Manufacturer(models.Model):
    ...
    # tenant = models.ForeignKey(Tenant  # Temporarily commented, on_delete=models.CASCADE, related_name='manufacturers')
...
class Medicine(models.Model):
    ...
    # tenant = models.ForeignKey(Tenant  # Temporarily commented, on_delete=models.CASCADE, related_name='medicines', default=1)
...
class Prescription(models.Model):
    ...
    # Basic Information
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    # tenant = models.ForeignKey(Tenant  # Temporarily commented, on_delete=models.CASCADE, related_name='prescriptions')
    ...
    def generate_prescription_number(self):
        ...
        return f"{self.tenant.subdomain}-RX-{date_str}-{new_number:04d}"
...
class PharmacySale(models.Model):
    ...
    # Basic Information
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    # tenant = models.ForeignKey(Tenant  # Temporarily commented, on_delete=models.CASCADE, related_name='pharmacy_sales')
    ...
    def generate_sale_number(self):
        ...
        return f"{self.tenant.subdomain}-SALE-{date_str}-{new_number:05d}"
