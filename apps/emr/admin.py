...
admin.site.site_header = "HMS EMR Administration"
admin.site.site_title = "HMS EMR Admin"
admin.site.index_title = "EMR Management with AI Clinical Decision Support"
