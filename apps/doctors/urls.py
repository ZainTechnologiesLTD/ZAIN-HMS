...
urlpatterns = [
    ...
    # Bulk Actions
    path('bulk-action/', views.DoctorBulkActionView.as_view(), name='doctor_bulk_action'),
    ...
    # Schedule Management
    path('schedules/', DoctorScheduleListView.as_view(), name='schedule_list'),
    path('schedules/<int:doctor_id>/', DoctorScheduleManageView.as_view(), name='schedule_manage'),
    path('schedules/api/<int:doctor_id>/', doctor_schedule_api, name='schedule_api'),
    path('schedules/template/<int:template_id>/', schedule_template_detail, name='schedule_template_detail'),
    path('leave/submit/', submit_leave_request, name='submit_leave_request'),
