...
class AppointmentForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if True:  # Unified ZAIN HMS system
            ...
            hospital_user_ids = list(User.objects.filter(
                role='DOCTOR'
    ...
    def clean(self):
        ...
        if appointment_date and appointment_time:
            ...
            if doctor:
                # Single hospital system - use default database# 
    ...
    def save(self, commit=True):
        """Override save to ensure proper database routing"""
        # Single hospital system - removed tenant database manager
        
        appointment = super().save(commit=False)
        
        if commit:
            # Save to default database (single hospital system)
            appointment.save()
