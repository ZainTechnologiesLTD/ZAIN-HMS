...
class BaseModel(models.Model):
    """
    Abstract base model for ZAIN HMS unified system
...
class SystemConfiguration(models.Model):
    ...
    # General Settings
    system_name = models.CharField(max_length=200, default='ZAIN Hospital Management System')
    system_logo = models.ImageField(upload_to='system/logos/', null=True, blank=True)
    ...
    def __str__(self):
        return f"Configuration for {self.system_name}"
